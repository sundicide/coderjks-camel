...
public final class CamelJmsToFileExample {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // The file component is listening for messages from the Queue test.queue,
        // consumes them and stores them to disk.
        // The content of each file will be the test we sent here.
